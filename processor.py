    ...
    try:
        ...
        result = subprocess.run(
            [
                ...
                '-e', '7',  # Good effort (faster than 9, minimal size difference)
            ],
            capture_output=True,
            text=True,
    ...
    try:
        with Image.open(image_path) as img:
            ...
            if is_animated_gif(image_path):
                ...
                try:
                    ...
                    frames[0].save(
                        ...
                        duration=durations,
                        lossless=True,
                        method=4,  # Good compression (faster than 6, minimal size difference)
            ...
            img.save(
                ...
                format='WEBP',
                lossless=True,
                method=4,  # Good compression method (0-6, 4 is faster than 6 with minimal size difference)
